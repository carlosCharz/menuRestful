...
public class Util {
	...
	public static final String SERVER_ERROR_MESSAGE = "Server Error: Handling 500 error on a menu entry";
	public static final String NOT_FOUND_ERROR_MESSAGE = "Not Found Error: Handling 404 error on a menu entry";
